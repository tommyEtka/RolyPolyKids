...
public class OutdoorInfo {
	...
	public OutdoorInfo(String link, String imgSrc, String title,String favoritesTag) {
		super();
		this.link = link;
		this.imgSrc = imgSrc;
		this.title = title;
	...
	public OutdoorInfo(String link, String imgSrc) {
		super();
		this.link = link;
		this.imgSrc = imgSrc;
	...
	public OutdoorInfo(String link) {
		super();
		this.link = link;
